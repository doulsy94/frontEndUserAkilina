...
export class UserupdateComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private modal:ModalController, private user: UsersService, private http: HttpClient, private storageService: TokenStorageService, private router: Router) {}
