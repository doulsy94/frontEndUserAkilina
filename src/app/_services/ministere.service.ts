...
export class MinistereService {
  ...
  ajouterMinistere(file: File, libelle: any, description: any): Observable<any> {
  ...
  modifierMinistere(id_ministere: any, file: File, libelle: any, description: any): Observable<any> {
